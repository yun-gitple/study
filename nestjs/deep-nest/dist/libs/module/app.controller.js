...
const dogs_breed_service_1 = require("./libs/module/dogs-breed.service");
let AppController = class AppController {
    constructor(appService, breedService) {
    ...
    async getBreed() {
        return this.breedService.getBreed();
    }
};
__decorate([
    (0, common_1.Get)(),
...
AppController = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof app_service_1.AppService !== "undefined" && app_service_1.AppService) === "function" ? _b : Object, typeof (_c = typeof dogs_breed_service_1.DogBreedService !== "undefined" && dogs_breed_service_1.DogBreedService) === "function" ? _c : Object])
], AppController);
